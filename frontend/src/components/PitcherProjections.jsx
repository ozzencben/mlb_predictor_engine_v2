...
const PitcherCard = ({ p, metricFilter = 'ALL' }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute top-0 left-0 right-0 h-[2px] ${hasAnyEdge
        ...
        <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-3 text-center md:text-left">
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 flex-wrap">
                                <h2 className="text-sm sm:text-base md:text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-indigo-400 to-purple-400 uppercase tracking-widest">
                                    Pitcher Props Model
                                </h2>
                                <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 bg-cyan-500/10 border border-cyan-500/20 rounded-xl">
                                    ...
                                    <span className="text-[9px] text-cyan-400 font-extrabold uppercase tracking-widest">Live</span>
                                </div>
                            </div>
                            <p className="text-slate-500 text-[10px] md:text-xs font-semibold mt-0.5 leading-relaxed max-w-lg mx-auto md:mx-0">
                ...
                <div className="flex p-0.5 bg-slate-950/60 border border-slate-800/80 rounded-lg h-8 w-full sm:w-80">
                    {[
                        ...
                        <button
                            ...
                            className={`flex-1 rounded-md text-[9px] font-black uppercase tracking-wider transition-all duration-250 border ${sortSubFilter === item.key
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-2">
                ...
                <div className="flex p-1 bg-slate-900/60 border border-slate-800 rounded-xl h-10 col-span-1">
                    {['ALL', 'R', 'L'].map((hand) => (
                        <button
                            ...
                            className={`flex-1 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all duration-200 ${handFilter === hand
                ...
                <div className="flex p-1 bg-slate-900/60 border border-slate-800 rounded-xl h-10 col-span-1">
                    {[
                        ...
                        <button
                            ...
                            className={`flex-1 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all duration-200 ${metricFilter === m.key
                                    ? 'bg-cyan-500/15 border border-cyan-500/30 text-cyan-400'
                                    : 'text-slate-400 hover:text-slate-200'
                                }`}
                        >
                ...
                <div className="flex p-1 bg-slate-900/60 border border-slate-800 rounded-xl h-10 col-span-1">
                    {[
                        ...
                        <button
                            ...
                            className={`flex-1 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all duration-200 ${sortBy === s.key
                ...
                <button
                    ...
                    className={`flex items-center justify-center gap-1.5 h-10 px-3 border rounded-xl transition-all duration-300 text-[9px] font-black uppercase tracking-wider col-span-2 md:col-span-1 ${edgesOnly
